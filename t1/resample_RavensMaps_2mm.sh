...
for i in /data/joy/BBL/studies/reward/processedData/structural/ravens/*/*/*_RAVENS_2.nii.gz; do 

##Get BBLID and SCANID
root=/data/joy/BBL/studies/reward/processedData/structural/ravens
id=`echo $i | cut -d "/" -f10`; 
sc=`echo $i | cut -d "/" -f11`;
