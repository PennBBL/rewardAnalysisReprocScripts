...
# Delcare any statics
jlfDirectory="/data/joy/BBL/studies/reward/processedData/struct_pipeline/struct_pipeline_201705311006/*/*/jlf/"
jlfVolDir="/data/joy/BBL/projects/rewardAnalysisReproc/qa/temp/"
ctDirectory="/data/joy/BBL/studies/reward/processedData/struct_pipeline/struct_pipeline_201705311006/*/*/antsCT/"
...
for i in `find ${jlfDirectory} -name "*jlfLabelsANTsCTIntersection.nii.gz"` ; do vals=`fslstats ${i} -H 208 0 207` ; echo ${i} ${vals} ; done >> ${jlfVolDir}jlfVolValues_20170719.txt
